...
class Detail {
  ...
  renderPageFromId(myId) {
    for (var a of this.myProductArray) {
      if (a.id == myId) {
        var myHtml = `<div class="modal fade" id="productView" tabindex="-1">
                  ...
                  <div class="row mb-5">
                        ...
                        <div class="col-sm-2 p-sm-0 order-2 order-sm-1 mt-2 mt-sm-0 px-xl-2">
                          <div class="swiper product-slider-thumbs">
                            <div class="swiper-wrapper">
                              <div class="swiper-slide h-auto swiper-thumb-item mb-3"><img class="w-100" src="${a.imgSrc}" alt="..."></div>
                              <div class="swiper-slide h-auto swiper-thumb-item mb-3"><img class="w-100" src="${a.imgSrc}" alt="..."></div>
                              <div class="swiper-slide h-auto swiper-thumb-item mb-3"><img class="w-100" src="${a.imgSrc}" alt="..."></div>
                              <div class="swiper-slide h-auto swiper-thumb-item mb-3"><img class="w-100" src="${a.imgSrc}" alt="..."></div>
                            </div>
                    ...
                    <div class="col-lg-6">
                      ...
                      <ul class="list-unstyled small d-inline-block">
                        <li class="px-3 py-2 mb-1 bg-white"><strong class="text-uppercase">Ürün Kodu:</strong><span class="ms-2 text-muted">039</span></li>
                        <li class="px-3 py-2 mb-1 bg-white text-muted"><strong class="text-uppercase text-dark">Kategori:</strong><a class="reset-anchor ms-2" href="#!">Demo Products</a></li>
                        <li class="px-3 py-2 mb-1 bg-white text-muted"><strong class="text-uppercase text-dark">Tagler:</strong><a class="reset-anchor ms-2" href="#!">Innovation</a></li>
                      </ul>
                    </div>
                  </div>
                  <!-- DETAILS TABS-->
        ...
        document.getElementById("refHeader").insertAdjacentHTML("afterend", myHtml);
      }
    }
  }
}

var myTemp = new Detail();
myTemp.renderPageFromId(1);